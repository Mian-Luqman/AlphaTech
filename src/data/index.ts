...
export const CARDS = [
  {
    ...
    description:
      'Transform your business with our comprehensive digital solutions. From web development to digital marketing, we help you establish a strong online presence and reach your target audience effectively.',
    services: [
  ...
  },
  {
    ...
    description:
      'Streamline your operations with our essential utility services. We provide reliable solutions for merchant services, electricity, broadband, and gas to keep your business running smoothly.',
    services: [
      ['Merchant Services', 'Electricity'],
      ['BroadBand', 'Gas'],
    ],
    number: '02.',
